...
def compare_os_rmse(learner1, learner2, x, y):  		  	   		  		 			  		 			     			  	 
    ...
    # pred_y = learner2.predict(test_x)	  	   		  		 			  		 			     			  	 
...
def test_code(seed):  		  	   		  		 			  		 			     			  	 
    ...
    # dtlearner = DecisionTreeRegressor(random_state = 0) 		  	   		  		 			  		 			     			  	 
...
if __name__ == "__main__":  
    # f = 0
    # for i in range(15):
    #     if(test_code(np.random.randint(1489683273,2489683273)) == "fail"):
    #         f += 1
    # print("failed: " + str(f))
    test_code(1489683273)